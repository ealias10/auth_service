...
public class UserService {
    ...
    public UsersVO createUser(UserCreateRequest request) throws RoleNotFoundException, UsersExistsException{
        try {
    ...
    public String forgotPasswordByUser(String userNameOrEmail) throws InvalidUserNameOrEmailException, EmailServiceException {
